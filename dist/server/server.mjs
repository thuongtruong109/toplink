import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, ref, watchEffect, watch, h, shallowRef, shallowReactive, isReadonly, markRaw, toRaw, isRef, isReactive, nextTick, computed, getCurrentScope, onScopeDispose, toRefs, defineComponent, provide, createElementBlock, isShallow, onUnmounted, Fragment, createVNode, Text, Suspense, mergeProps, Transition, withCtx, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
This will fail in production.`);
    ...
    if (process.env.NODE_ENV !== "production" && hot) {
      ...
      const newStore = isSetupStore ? createSetupStore(hotId, setup2, options, pinia, true) : createOptionsStore(hotId, assign$2({}, options), pinia, true);
...
const plugin_dUrdF0P1fL = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.hook("app:mounted", () => {
    const meta = (void 0).createElement("meta");
    meta.name = "naive-ui-style";
    (void 0).head.appendChild(meta);
  });
  {
...
const unocss_LiLcAdPlqk = /* @__PURE__ */ defineNuxtPlugin(() => {
});
const plugins = [
  unhead_KgADcZ0jPj,
  plugin$2,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Html, mergeProps({ lang: unref(locale) }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_Body, { class: "text-gray-800 antialiased transition-colors duration-300 dark:text-gray-200" }, {
            ...
            return [
              createVNode(_component_Body, { class: "text-gray-800 antialiased transition-colors duration-300 dark:text-gray-200" }, {
                default: withCtx(() => [
                  createVNode(_component_NuxtLayout, null, {
                    default: withCtx(() => [
                      createVNode(_component_NuxtPage)
